    ...
    if (best.confidence > 50) {
      if (best.type === "web-extension") {
        suggestedAdapter = new WebExtensionAdapter({
          tsConfigPath: this.project.getCompilerOptions().configFilePath as string || "tsconfig.json",
          maxInFlight: 6,
          maxTabs: 2,
        })
