...
describe("Round-Trip Validation", () => {
	...
	describe("Message Type Extraction", () => {
		...
		test("detects missing message type", async () => {
			...
			expect(result.errors.some((e) => e.component === "message-type" && e.type === "missing")).toBe(true);
		});
		...
		test("detects extra message type", async () => {
			...
			expect(result.valid).toBe(false);
			expect(result.errors.some((e) => e.component === "message-type" && e.type === "extra")).toBe(true);
		});
...
`;
			...
			expect(result.valid).toBe(false);
			expect(result.errors.some((e) => e.component === "state-field" && e.type === "missing")).toBe(true);
		});
...
`;
			...
			expect(result.valid).toBe(false);
			expect(result.errors.some((e) => e.component === "handler" && e.type === "missing")).toBe(true);
		});
